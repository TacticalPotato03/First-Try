...
export const cards = [
  {
    ...
    subtitle: "Obsidian + Templater + Dataview",
    description: "Local-first vault. Templater runs the automation scripts. Dataview powers the daily dashboard and TBD warnings.",
  },
  {
    title: "The Incubator",
    subtitle: "Master List.md",
    description: "Single file for raw sparks. Monthly cull moves stale ideas to Archive. Stays under 15 items.",
  },
  {
    title: "The Factory Floor",
    subtitle: "Single project file per build",
    description: "YAML frontmatter, collapsible Version Log, and a copy-pasteable AI Context Block that separates working from broken state.",
  },
  {
    title: "The Cockpit",
    subtitle: "Daily Notes + Next_Handover.md",
    description: "Rolling dashboard injecting yesterday's handover, displaying all active projects, and flagging undefined intents.",
  },
  {
    title: "Build Execution",
    subtitle: "Claude Code, Gemini, VS Code",
    description: "Heavy lifting happens externally. Obsidian holds the \"intellectual DNA,\" not the code itself.",
  },
  {
    title: "Streak Tracking",
    subtitle: "Session Count + Energy Level",
    description: "Per-project counter plus daily energy tag. Reveals momentum patterns and matches tasks to brainpower.",
  },
];
